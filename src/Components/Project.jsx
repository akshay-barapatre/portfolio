    ...
    <>
        ...
        <Cont key={uuid()}>
            <ImgCont>
                  ...
                  <div style={{ display:"flex"}}><p>Description:</p>&nbsp;{el.desc}</div>
                  <div style={{ display:"flex"}}>
                    <p>Tech Stack: </p>&nbsp; <h5 style={{ color:"blue",marginTop:"2px"}}>{el.stack}</h5>
                  </div>
            <div style={{ display:"flex"}}>
               <p>Feature: </p> &nbsp;{el.Feature} 
            </div>
            <div style={{ marginTop:"-5px"}}>
                 <p>Responsibility: </p>&nbsp;{el.Responsibility}
             </div>
              </DetailData> : null
